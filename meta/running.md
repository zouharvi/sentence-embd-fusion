...
1 may|100k|eurythmics|vectorizer|`./src/run_model_basic.py -d /data/sef/tfidf-100k-p.embd -f 1 -nn eurythmics -mn tfidf -v 8192`|15|running
1 may|100k|septenary|vectorizer|`./src/run_model_basic.py -d /data/sef/count-100k-p.embd -f 1 -nn septenary -mn count -v 8192`|15|running
